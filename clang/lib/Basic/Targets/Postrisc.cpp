...
void PostriscV1TargetInfo::getTargetDefines(const LangOptions &Opts,
  ...
  Builder.defineMacro("__POSTRISC_RM_RNE", "0");
  Builder.defineMacro("__POSTRISC_RM_RTZ", "1");
  Builder.defineMacro("__POSTRISC_RM_RDN", "2");
  Builder.defineMacro("__POSTRISC_RM_RUP", "3");
  Builder.defineMacro("__POSTRISC_RM_RMM", "4");
  Builder.defineMacro("__POSTRISC_RM_DYN", "7");
}

...
void PostriscV1TargetInfo::getTargetDefines(const LangOptions &Opts,
  ...
  // builtin rounding modes
  Builder.defineMacro("__POSTRISC_RM_RNE", Twine(llvm::postrisc::RM_RNE));
  Builder.defineMacro("__POSTRISC_RM_RTZ", Twine(llvm::postrisc::RM_RTZ));
  Builder.defineMacro("__POSTRISC_RM_RDN", Twine(llvm::postrisc::RM_RDN));
  Builder.defineMacro("__POSTRISC_RM_RUP", Twine(llvm::postrisc::RM_RUP));
  Builder.defineMacro("__POSTRISC_RM_RMM", Twine(llvm::postrisc::RM_RMM));
  Builder.defineMacro("__POSTRISC_RM_RNO", Twine(llvm::postrisc::RM_RNO));
  Builder.defineMacro("__POSTRISC_RM_RTO", Twine(llvm::postrisc::RM_RTO));
  Builder.defineMacro("__POSTRISC_RM_DYN", Twine(llvm::postrisc::RM_DYN));
}

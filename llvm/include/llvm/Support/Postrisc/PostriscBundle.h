...
namespace postrisc {
  ...
  enum class InstructionFieldSize : int {
      CallDisp = 28,
      ForwardDisp = 28,
      BranchDisp = 17,
  };

  enum class LongInstructionFieldSize : int {
      CallDisp = 60,
      ForwardDisp = 64,
      BranchDisp = 30,
  };

  enum class InstructionFieldExtSize : int {
      CallDisp = (int)LongInstructionFieldSize::CallDisp - (int)InstructionFieldSize::CallDisp,
      ForwardDisp = (int)LongInstructionFieldSize::ForwardDisp - (int)InstructionFieldSize::ForwardDisp,
      BranchDisp = (int)LongInstructionFieldSize::BranchDisp - (int)InstructionFieldSize::BranchDisp,
  };

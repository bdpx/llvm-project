  ...
  const MCSubtargetInfo *STI) const
{
  ...
  FIXUP_ALL_FORMS_CASES(JUMP)
    ...
    FixupBranch(bundle, Value, slottype,
      ...
      0, (int)llvm::postrisc::InstructionFieldExtSize::CallDisp);
    break;
  ...
  FIXUP_ALL_FORMS_CASES(BRANCH)
    ...
    FixupBranch(bundle, Value, slottype,
      ...
      0, (int)llvm::postrisc::InstructionFieldExtSize::BranchDisp);
    break;

  FIXUP_ALL_FORMS_CASES(PCREL_FWD)
    slottype = (postrisc::slot_type)(Kind - Postrisc::FIXUP_POSTRISC_A_PCREL_FWD);
    FixupOffset(bundle, Value, slottype,
      0, (int)llvm::postrisc::InstructionFieldSize::ForwardDisp,
      0, (int)llvm::postrisc::InstructionFieldExtSize::ForwardDisp);
    break;

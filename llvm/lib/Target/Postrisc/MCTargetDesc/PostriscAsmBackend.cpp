...
namespace {
  ...
  public:
    ...
    unsigned getNumFixupKinds() const override {
      return Postrisc::NumTargetFixupKinds;
    }
    ...
    bool shouldForceRelocation(const MCAssembler &Asm, const MCFixup &Fixup,
      ...
      LLVM_DEBUG(dbgs() << "PostriscAsmBackend::shouldForceRelocation "
...
void
ELFPostriscAsmBackend::applyFixup(
  ...
  const MCSubtargetInfo *STI) const
{
  ...
  LLVM_DEBUG(dbgs()
         << "applyFixup: Kind=" << Kind
         << " " << getFixupKindInfo((MCFixupKind)Kind).Name
         << " FValue=" << *Fixup.getValue()
         << " Offset=" << Offset
         << " Value=" << (int64_t)Value << "\n");
  ...
  FIXUP_ALL_FORMS_CASES(JUMP)
    ...
    FixupBranch(bundle, Value, slottype,
      0, (int)llvm::postrisc::InstructionFieldSize::CallDisp,
      0, (int)llvm::postrisc::LongInstructionFieldSize::CallDisp - (int)llvm::postrisc::InstructionFieldSize::CallDisp);
    break;

  FIXUP_ALL_FORMS_CASES(BRANCH)
    slottype = (postrisc::slot_type)(Kind - Postrisc::FIXUP_POSTRISC_A_BRANCH);
    FixupBranch(bundle, Value, slottype,
      0, (int)llvm::postrisc::InstructionFieldSize::BranchDisp,
      0, (int)llvm::postrisc::LongInstructionFieldSize::BranchDisp - (int)llvm::postrisc::InstructionFieldSize::BranchDisp);
    break;
  ...
  FIXUP_ALL_FORMS_CASES(PCREL_FWD)
    ...
    FixupOffset(bundle, Value, slottype,
      0, (int)llvm::postrisc::InstructionFieldSize::CallDisp,
      0, 64 - (int)llvm::postrisc::InstructionFieldSize::CallDisp);
    break;

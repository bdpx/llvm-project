...
#define POSTRISC_VARIANT_KIND_TABLE_ENUM(NAME, FUNCNAME) \
  VK_POSTRISC_##NAME,
...
private:
  ...
  explicit PostriscMCExpr(VariantKind Kind, const MCExpr *Expr)
      : Kind(Kind), Expr(Expr) {}
...
public:
  ...
  static const PostriscMCExpr *create(VariantKind Kind, const MCExpr *Expr,
                                 MCContext &Ctx);
  /// @}
  /// @name Accessors
  /// @{
  ...
  Postrisc::Fixups getFixupKind() const { return getFixupKind(Kind); }
  ...
  static bool classof(const PostriscMCExpr *) { return true; }

  static VariantKind parseVariantKind(StringRef name);
  static bool printVariantKind(raw_ostream &OS, VariantKind Kind);
  static Postrisc::Fixups getFixupKind(VariantKind Kind);
};

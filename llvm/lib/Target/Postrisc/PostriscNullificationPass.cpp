...
#define AS_IS_NO_EXT(BCOND, NCOND)                                                              \
  ...
  AS_IS_NO_EXT(BR_LE_I32,   NUL_LE_I32)
  AS_IS_NO_EXT(BR_LE_I64,   NUL_LE_I64)
  AS_IS_NO_EXT(BR_LE_I128,  NUL_LE_I128)
  AS_IS_NO_EXT(BR_LT_U32,   NUL_LT_U32)
  AS_IS_NO_EXT(BR_LT_U64,   NUL_LT_U64)
  AS_IS_NO_EXT(BR_LT_U128,  NUL_LT_U128)
  AS_IS_NO_EXT(BR_LE_U32,   NUL_LE_U32)
  AS_IS_NO_EXT(BR_LE_U64,   NUL_LE_U64)
  AS_IS_NO_EXT(BR_LE_U128,  NUL_LE_U128)
  ...
  AS_IS_NO_EXT(BR_OLE_F32,  NUL_OLE_F32)
  ...
  AS_IS_NO_EXT(BR_ULE_F32,  NUL_ULE_F32)
  ...
  AS_IS_NO_EXT(BR_OLE_F64,  NUL_OLE_F64)
  ...
  AS_IS_NO_EXT(BR_ULE_F64,  NUL_ULE_F64)
  ...
  AS_IS_NO_EXT(BR_OLE_F128, NUL_OLE_F128)
  ...
  AS_IS_NO_EXT(BR_ULE_F128, NUL_ULE_F128)
...
#define AS_IS_EXT(BCOND, NCOND)                                                                     \
  ...
  AS_IS_EXT(BR_MASK_ALL,     NUL_MASK_ALL)
  AS_IS_EXT(BR_MASK_NOTALL,  NUL_MASK_NOTALL)
  AS_IS_EXT(BR_MASK_NONE,    NUL_MASK_NONE)
  AS_IS_EXT(BR_MASK_ANY,     NUL_MASK_ANY)
...
#define INVERT_COND_AND_SWAP_BLOCKS(BCOND, NCOND)                                                   \
  ...
  INVERT_COND_AND_SWAP_BLOCKS(BR_GE_IMM_I32,  NUL_LT_IMM_I32)
  INVERT_COND_AND_SWAP_BLOCKS(BR_GE_IMM_I64,  NUL_LT_IMM_I64)
  INVERT_COND_AND_SWAP_BLOCKS(BR_GE_IMM_I128, NUL_LT_IMM_I128)
  INVERT_COND_AND_SWAP_BLOCKS(BR_GE_IMM_U32,  NUL_LT_IMM_U32)
  INVERT_COND_AND_SWAP_BLOCKS(BR_GE_IMM_U64,  NUL_LT_IMM_U64)
  INVERT_COND_AND_SWAP_BLOCKS(BR_GE_IMM_U128, NUL_LT_IMM_U128)

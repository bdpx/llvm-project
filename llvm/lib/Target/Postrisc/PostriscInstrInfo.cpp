...
Register PostriscInstrInfo::isLoadFromStackSlot(const MachineInstr &MI,
  ...
  default:
    return 0;
  case POSTRISC::LD_U32:
  case POSTRISC::LD_I32:
    MemBytes = TypeSize::getFixed(4);
    break;
  case POSTRISC::LD_U64:
  case POSTRISC::LD_I64:
    MemBytes = TypeSize::getFixed(8);
    break;
  case POSTRISC::LD_I128:
...
Register PostriscInstrInfo::isStoreToStackSlot(const MachineInstr &MI,
  ...
  default:
    return 0;
  case  POSTRISC::ST_I32:
    MemBytes = TypeSize::getFixed(4);
    break;
  case POSTRISC::ST_I64:
    MemBytes = TypeSize::getFixed(8);
    break;
  case POSTRISC::ST_I128:
    MemBytes = TypeSize::getFixed(16);
    break;
  }
  if (MI.getOperand(1).isFI() && MI.getOperand(2).isImm() &&

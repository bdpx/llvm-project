...
#define DECLARE_INVERTED_WITHOUT_ARG_SWAP_COND_BRANCHES(X) \
  ...
  X(BR_MASK_ALL,    BR_MASK_NOTALL) \
  X(BR_MASK_NONE,   BR_MASK_ANY) \
...
#define DECLARE_INVERTED_WITH_ARG_SWAP_COND_BRANCHES(X) \
  ...
  X(BR_LT_I32,   BR_LE_I32) \
  X(BR_LT_I64,   BR_LE_I64) \
  X(BR_LT_I128,  BR_LE_I128) \
  X(BR_LT_U32,   BR_LE_U32) \
  X(BR_LT_U64,   BR_LE_U64) \
  X(BR_LT_U128,  BR_LE_U128) \
  /* olt invert=> uge swap=> ule */ \
  X(BR_OLT_F32,  BR_ULE_F32) \
  X(BR_OLT_F64,  BR_ULE_F64) \
  X(BR_OLT_F128, BR_ULE_F128) \
  /* ole invert=> ugt swap=> ult */ \
  X(BR_OLE_F32,  BR_ULT_F32) \
  X(BR_OLE_F64,  BR_ULT_F64) \
  X(BR_OLE_F128, BR_ULT_F128) \

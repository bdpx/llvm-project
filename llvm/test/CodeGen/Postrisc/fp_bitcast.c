...
// FIXME:
// CHECK-LABEL: @test_fp_bitcast_u16_to_f16
// CHECK: alloc_sp 2, 16
// CHECK: st_i16 %r1, %sp, 14
// CHECK: ld_u16 %r1, %sp, 14
// CHECK: retf 16
f16 test_fp_bitcast_u16_to_f16(u16 value) { return BITCAST(f16)value; }

// FIXME:
// CHECK-LABEL: @test_fp_bitcast_f16_to_u16
// CHECK: alloc_sp 2, 16
// CHECK: st_i16 %r1, %sp, 14
// CHECK: ld_u16 %r1, %sp, 14
// CHECK: retf 16
u16 test_fp_bitcast_f16_to_u16(f16 value) { return BITCAST(u16)value; }

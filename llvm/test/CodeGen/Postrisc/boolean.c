...
void test_write_i1(void) {
  ...
  // CHECK: stbr %r1, %pcfwd(test_bool_true)
  test_bool_true = true;
  // CHECK: stbr %gz, %pcfwd(test_bool_false)
  test_bool_false = false;

  extern volatile i8 test_i8_true;
  extern volatile i8 test_i8_false;

  // CHECK: stbr %r1, %pcfwd(test_i8_true)
  test_i8_true = true;
  // CHECK: stbr %gz, %pcfwd(test_i8_false)
  test_i8_false = false;

  extern volatile i16 test_i16_true;
  extern volatile i16 test_i16_false;

  // CHECK: sthr %r1, %pcfwd(test_i16_true)
  test_i16_true = true;
  // CHECK: sthr %gz, %pcfwd(test_i16_false)
  test_i16_false = false;

  extern volatile i32 test_i32_true;
  extern volatile i32 test_i32_false;

  // CHECK: stwr %r1, %pcfwd(test_i32_true)
  test_i32_true = true;
  // CHECK: stwr %gz, %pcfwd(test_i32_false)
  test_i32_false = false;

  extern volatile i64 test_i64_true;
  extern volatile i64 test_i64_false;

  // CHECK: stdr %r1, %pcfwd(test_i64_true)
  test_i64_true = true;
  // CHECK: stdr %gz, %pcfwd(test_i64_false)

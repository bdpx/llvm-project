...
{
  // CHECK: sl.add %r2, %r2, %r1, 3
  // CHECK: call.mi %r3, %r2, 0
  ft0 x = ftable[arg];
  return x() + arg;
}
...
{
  // CHECK: call.plt %r2, %pcfwd(gftable+40)

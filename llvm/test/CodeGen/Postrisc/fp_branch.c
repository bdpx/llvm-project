...
// README:
// compiler copies retf for eq/ne cases and revert conditions
...
// CHECK: br_olt_f64 %r2, %r1, .LBB10_2
...
// CHECK: br_ole_f64 %r2, %r1, .LBB11_2
...
// CHECK: br_une_f128 %r1, %r2, .LBB12_1
...
// CHECK: br_ueq_f128 %r1, %r2, .LBB13_1
...
// CHECK: br_olt_f128 %r1, %r2, .LBB14_2
...
// CHECK: br_ole_f128 %r1, %r2, .LBB15_2
...
// CHECK: br_olt_f128 %r2, %r1, .LBB16_2
...
// CHECK: br_ole_f128 %r2, %r1, .LBB17_2

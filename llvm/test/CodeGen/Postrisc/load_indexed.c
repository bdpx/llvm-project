...
// CHECK-NEXT: ld_xu32_u64 %r1, %r1, %r2, 3, 0
...
// CHECK: ld_xi32_u64 %r1, %r1, %r2, 3, 0
...
// CHECK: ld_xi32_u64 %r1, %r1, %r2, 3, 40
...
// CHECK: ld_xu32_u64 %r1, %r1, %r2, 3, 0
...
// CHECK: ld_xi64_u64 %r1, %r1, %r2, 3, 40
...
// CHECK: ld_xi32_u64.l %r1, %r1, %r2, 4, 328
...
// CHECK: add_imm_i32 %r2, %r2, 20
// CHECK-NEXT: ld_xu32_u64 %r1, %r1, %r2, 4, 8

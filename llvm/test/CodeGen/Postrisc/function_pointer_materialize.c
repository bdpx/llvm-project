...
{
  // CHECK: ca.r %r1, %jpc(test_static_function_pointer_target)
...
{
  // CHECK: ca.r %r1, %jpc(test_global_function_pointer_target)
...
{
  // CHECK: ca.r %r1, %jpc(test_extern_function_pointer_target)

...
{
// CHECK: allocsp 5, 16
// CHECK: addid   %r1, %r1, -10
// CHECK: brgeuid %r1, 6, .LBB
// CHECK: ldard %r2, %pcfwd(.LJTI0_0)
// CHECK: jmpt %r2, %r1
  switch (c) {
  case 10:
...
{
// CHECK: allocsp 5, 16
// CHECK: addiws %r2, %r1, -10
// CHECK: brgeuiw %r2, 6, .LBB
// FIXME: addiwz - merge or remove
// CHECK: addiwz %r1, %r1, -10
// CHECK: ldard %r2, %pcfwd(.LJTI1_0)
// CHECK: jmpt %r2, %r1
  switch (c) {
  case 10:

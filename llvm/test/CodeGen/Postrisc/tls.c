...
{
// MEDIUM:	ldafr.l %r4, %tgd_ext(x_tls)
// MEDIUM:	callr %r3, %jpc(__tls_get_addr)
// MEDIUM:	lddz %r2, %r4, 0

// LARGE:	ldafr.l %r4, %tgd_ext(x_tls)
// LARGE:	callr.l %r3, %jpc_ext(__tls_get_addr)
// LARGE:	lddz %r2, %r4, 0

// MEDIUM_LE:	lddz.l %r2, %tp, %tpoff_ext(x_tls)

// LARGE_LE:	lddz.l %r2, %tp, %tpoff_ext(x_tls)

// MEDIUM_IE:	lddzr.l %r2, %gottpoff_ext(x_tls)
// MEDIUM_IE:	lddzx %r2, %tp, %r2, 0, 0

// LARGE_IE:	lddzr.l %r2, %gottpoff_ext(x_tls)
// LARGE_IE:	lddzx %r2, %tp, %r2, 0, 0

// MEDIUM_LD:	ldafr.l	%r4, %tld_ext(x_tls)
// MEDIUM_LD:	callr	%r3, %jpc(__tls_get_addr)
// MEDIUM_LD:	lddz.l	%r2, %r4, %dtpoff_ext(x_tls)

// LARGE_LD:	ldafr.l	%r4, %tld_ext(x_tls)
// LARGE_LD:	callr.l	%r3, %jpc_ext(__tls_get_addr)
// LARGE_LD:	lddz.l	%r2, %r4, %dtpoff_ext(x_tls)

// MEDIUM_GD:	ldafr.l	%r4, %tgd_ext(x_tls)
// MEDIUM_GD:	callr	%r3, %jpc(__tls_get_addr)
// MEDIUM_GD:	lddz	%r2, %r4, 0

// LARGE_GD:	ldafr.l	%r4, %tgd_ext(x_tls)
// LARGE_GD:	callr.l	%r3, %jpc_ext(__tls_get_addr)
// LARGE_GD:	lddz	%r2, %r4, 0
...
{
// MEDIUM:	ldafr.l %r4, %tgd_ext(x_tls_extern)
// MEDIUM:	callr %r3, %jpc(__tls_get_addr)
// MEDIUM:	lddz %r2, %r4, 0

// LARGE:	ldafr.l %r4, %tgd_ext(x_tls_extern)
// LARGE:	callr.l %r3, %jpc_ext(__tls_get_addr)
// LARGE:	lddz %r2, %r4, 0

// MEDIUM_LE:	lddz.l %r2, %tp, %tpoff_ext(x_tls_extern)

// LARGE_LE:	lddz.l %r2, %tp, %tpoff_ext(x_tls_extern)

// MEDIUM_IE:	lddzr.l %r2, %gottpoff_ext(x_tls_extern)
// MEDIUM_IE:	lddzx %r2, %tp, %r2, 0, 0

// LARGE_IE:	lddzr.l %r2, %gottpoff_ext(x_tls_extern)
// LARGE_IE:	lddzx %r2, %tp, %r2, 0, 0

// MEDIUM_LD:	ldafr.l	%r4, %tld_ext(x_tls_extern)
// MEDIUM_LD:	callr	%r3, %jpc(__tls_get_addr)
// MEDIUM_LD:	lddz.l	%r2, %r4, %dtpoff_ext(x_tls_extern)

// MEDIUM_GD:	ldafr.l	%r4, %tgd_ext(x_tls_extern)
// MEDIUM_GD:	callr	%r3, %jpc(__tls_get_addr)
// MEDIUM_GD:	lddz	%r2, %r4, 0

// LARGE_LD:	ldafr.l %r4, %tld_ext(x_tls_extern)
// LARGE_LD:	callr.l %r3, %jpc_ext(__tls_get_addr)
// LARGE_LD:	lddz.l  %r2, %r4, %dtpoff_ext(x_tls_extern)

// LARGE_GD:	ldafr.l %r4, %tgd_ext(x_tls_extern)
// LARGE_GD:	callr.l %r3, %jpc_ext(__tls_get_addr)
// LARGE_GD:	lddz    %r2, %r4, 0
